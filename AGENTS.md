...
| Config | Supervisor writes `/data/options.json` (media folder, four library folders, after-download sharing, debug) | We supply [`tests/options.json`](tests/options.json) ourselves |
