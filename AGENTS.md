...
| Config | Supervisor writes `/data/options.json` (media folder, four library folders, after-download sharing, language/anime-audio/subtitles) | We supply [`tests/options.json`](tests/options.json) ourselves |
