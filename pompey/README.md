...
**0.2.7 is meant for a first Home Assistant OS try** if you have Proton, a Plex IP, and a source. See the [root README](../README.md) and [DOCS.md](DOCS.md). It is not a finished household app.
