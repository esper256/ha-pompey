...
pin_arr_log_level(f"{config}/sonarr/config.xml")
pin_arr_log_level(f"{config}/radarr/config.xml")
publish_prowlarr(f"{config}/prowlarr/config.xml", secrets["prowlarr_api_key"])
pin_arr_docker_updates(f"{config}/sonarr/config.xml")
pin_arr_docker_updates(f"{config}/radarr/config.xml")
pin_arr_docker_updates(f"{config}/prowlarr/config.xml")
