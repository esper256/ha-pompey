...
Plex in the options is a **shortcut**. Seerr’s web setup is the canonical Plex connection. After that wizard, Seerr already has Plex; Pompey does not copy the token back into Home Assistant options. Source URL/key are for Prowlarr.
