...
Release confidence comes from fast behavioral/failure tests, a smaller pinned real-engine contract suite, production-layout smoke tests, and final manual HAOS acceptance. Upstream candidate jobs should reveal API drift before it becomes a household update. No test starts a torrent engine or contacts peers.
