...
| Engines stay current for years | First fetch only. Already-present binaries are skipped on restart. Arr’s own updater is off (`UpdateAutomatically=False`, mechanism Docker). Months of uptime freeze Radarr at the first download. |
