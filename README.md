...
- A TV season searches some episodes in **Open sources** then sits: rebuild to **0.2.35**. The app log will show Sonarr’s command queue and wanted/missing *before* housekeeping asks it to scan `complete/` again. Send that stretch of the log (not API keys).
